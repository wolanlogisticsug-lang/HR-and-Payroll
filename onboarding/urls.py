...
from . import views
from core.views import BiometricSyncExecutionAPIView, BiometricDeviceListCreateAPIView
...
urlpatterns = [
    ...
    path('api/v1/biometric/devices', BiometricDeviceListCreateAPIView.as_view(), name='api-biometric-devices'),
    path('api/v1/biometric/sync', BiometricSyncExecutionAPIView.as_view(), name='api-biometric-sync'),
]